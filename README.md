...
```bash
git clone https://github.com/jaikaran109/51_Web_Projects.git
```
...
Choose any project folder and open the `index.html` file in your browser.
...
```bash
git clone https://github.com/your-github-username/51_Web_Projects.git
```
